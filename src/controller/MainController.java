...
public class MainController implements ChatListener{
    ...
    @FXML private Label currentRoomTitle;
        ...
        Platform.runLater(() -> {
            ...
            for (String room : rooms) {
                ...
                if (roomNameOnly.equals(currentRoom)) {
                    roomLabel.setStyle("-fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 10; -fx-cursor: hand; -fx-background-color: #404249; -fx-background-radius: 5;");
                } else {
                    roomLabel.setStyle("-fx-text-fill: #949ba4; -fx-font-weight: bold; -fx-padding: 10; -fx-cursor: hand;");
   
                    roomLabel.setOnMouseEntered(e -> roomLabel.setStyle("-fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 10; -fx-cursor: hand; -fx-background-color: #35373c; -fx-background-radius: 5;"));
                    roomLabel.setOnMouseExited(e -> roomLabel.setStyle("-fx-text-fill: #949ba4; -fx-font-weight: bold; -fx-padding: 10; -fx-cursor: hand;"));
                }
    ...
    public void onKickedOrClosed(String reason) {
    	Platform.runLater(() -> {
            ...
            messageContainer.getChildren().clear();
            if (memberListContainer != null) memberListContainer.getChildren().clear();
        ...
        Platform.runLater(() -> {
            ...
            for (String member : members) {
                ...
                if (amIOwner && !member.equals(userName + " (Owner)")) {
                    ...
                    kickBtn.setStyle("-fx-background-color: #da373c; -fx-text-fill: white; -fx-font-size: 10px; -fx-cursor: hand; -fx-background-radius: 3; -fx-padding: 3 8; -fx-font-weight: bold;");
